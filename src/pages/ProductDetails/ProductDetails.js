      ...
      <Row className="justify-content-center align-items-center">
        <Col sm={12} md={6} className="text-center bg-secondary h-100">
          <img
            ...
            alt="product details page of The Generics"
          />
        </Col>
        <Col sm={12} md={6} className="bg-light p-4">
          ...
          <p>
            ...
            laborum cumque facilis tempora ut. Aperiam consequatur animi amet
            consectetur consequuntur, enim unde hic repudiandae maxime quas
            nostrum asperiores error nulla.
          </p>
